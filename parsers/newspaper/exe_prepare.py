...
db_query_all = "select * from sampleTable order by url ASC, Time_Check DESC\""
if(domain == "ALL"):
	db_query_selected = "select * from sampleTable order by url ASC, Time_Check DESC\""
else:
	db_query_selected = "select * from sampleTable where Domain= \\\"" + domain + "\\\" order by url ASC, Time_Check DESC\""
