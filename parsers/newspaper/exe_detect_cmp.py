...
db_query_distinct = "select distinct url from articles where Time_Publish > DATE_SUB(now(), INTERVAL 2 DAY) order by url ASC, Time_Check DESC\""
db_query_all = "select * from articles where Time_Publish > DATE_SUB(now(), INTERVAL 2 DAY) order by url ASC, Time_Check DESC\""
